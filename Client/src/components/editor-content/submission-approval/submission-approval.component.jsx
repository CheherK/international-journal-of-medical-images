...
const rows = [
   ...
   createData(4, 'Exploring the Role of Artificial Intelligence in Medical Imaging', <Link style={{color: 'blue', textDecoration: 'underline'}}>view submission</Link>, "26-05-2023", 
   <div> 
   <Button variant="contained" color="success">
      Approve
   </Button>
